...
void play_multi_mode()
{
	...
	WINDOW *win_problem = newwin(30, 70, 10, 10);
	//WINDOW *win_submit = newwin(30, 70, 4, 70);
//	WINDOW *win_form = derwin(win_submit, 20, 60, 4, 4);
//	mvwprintw(win_submit, 1, 15, "Write your answers");
